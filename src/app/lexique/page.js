    ...
    <div className={css.container}>
      ...
      <div className={css.contain}>
        ...
        <div className={css.definition}>
          ...
          <p>
          Son but est de vendre, vue le nombre de fonctionnalités à intégrer (paiement livraison, base de données produits, client etc …), les produits, catégories, voir en plus un blog, selon le nombre de passage/jour il faut un bon hébergement, et une bonne application de gestion (voir Prestashop*). 
          </p>
        </div>
        <div className={css.definition}>
          <h3>PRESTASHOP :</h3>
