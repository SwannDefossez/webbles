          ...
          <div ref={parentRef}>
            <div className={css.main__text} ref={textRef}>
              ...
              <p>
                ...
                si vous ne les faites pas vivre, malgré une bonne optimisation,
                ça ne vous apportera que peu de trafic, une boutique il faut
                créer ses produits, les mettre à jour, nous proposons soit un
                accompagnement de quelques heures à la livraison soit un pack
                mensuel adapté à vos besoins.
              </p>
              <p>
                L’hébergement et le nom de domaine de votre site seront votre
                propriété, cela vous assure que votre site n’est pas sur un
                hébergement surbooké et vous êtes libres, si pour une raison ou
                une autre, vous décidez de faire appel à un autre professionnel.
              </p>
              ...
              <p>
                ...
                collaborer avec des clients à distance et de travailler sur des
